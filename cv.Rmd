...
tribble(
  ...
  "Research Assistant", "Institute of Latin American Studies, University of Columbia", "", "Aug 2021 - Aug 2021", 
...
```{r}
tribble(
  ~ role, ~ course, ~ organisation, ~ dates,
"Co-coordinator and Instructor", "Introduction to R for Social Scientists", "Argentine School of New Technologies",  "Mar 2020 - Jul 2021",  
) %>% 
 brief_entries(glue::glue("\\textbf{<course>}: <role> (<organisation>)", .open = "<", .close = ">"), paste0(dates, "\\newline"), .protect = FALSE)
```
...
tribble(
  ~ role, ~ course, ~ organisation, ~ dates,
  "Graduate Teaching Assistant", "Laboratory of Public Policy", "University of Buenos Aires", "Mar 2020 - Jul 2021", 
  "Graduate Teaching Assistant", "Introduction to Political Science", "University of el Salvador (Argentina)", "Mar 2020 - Jul 2021"
) %>% 
 brief_entries(glue::glue("\\textbf{<course>}: <role> (<organisation>)", .open = "<", .close = ">"), paste0(dates, "\\newline"), .protect = FALSE)
...
tribble(
  ~ role, ~ course, ~ organisation, ~ dates,
   "Instructor", "Machine Learning with R", "Argentine School of New Technologies",  "Jun 2020 - Aug 2021", 
   "Instructor", "Introduction to Python", "Argentine School of New Technologies",  "Jun 2020 - Aug 2021", 
    "Instructor", "Statistics and R for the work life: tools of 21 century to solve everyday problems", "Santa Fé Capacita", "Apr 2021 - May 2021"
) %>% 
 brief_entries(glue::glue("\\textbf{<course>}: <role> (<organisation>)", .open = "<", .close = ">"), paste0(dates, "\\newline"), .protect = FALSE)
```
...
tribble(
  ...
  "https://guadag12.github.io/polentwitter-presentation/",
  "Oct, 2021", "Introduction to social network analysis with R", "Social Network Analysis in R using 'politicxsentwitteR'", "Rladies Buenos Aires", "https://guadag12.github.io/socialnetwork-rladies-talk/",
  "Sep, 2021", "Introduction to text mining", "Importance of text analytics in social science", "University of Buenos Aires", "https://guadag12.github.io/talk-textmining-uba/",
    "Jul, 2020", "Introduction to R for social scientists", "Workshop about basic coding in R and statistics", "Argentine School of New Technologies", "https://eant.tech/escuela-de-ciencias-de-datos/cursos/taller-data-analytics-para-ciencias-sociales",
      "Jul, 2020", "Analyzing Argentine politics with twitter data",
  "Open Class to learn how to use 'twitteR' and 'rtweet' package in R", "University of Buenos Aires", "https://github.com/labpoliticasuba/Taller-de-Twitter"
...
tribble(
  ...
  "Spring School in Machine Learning", "University of Oxford", "Oxford, United Kingdom", "Mar 2023",
